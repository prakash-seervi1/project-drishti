...
export default function IncidentQuickStats({ incident }) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
      {incident.crowdData && (
        <div className="bg-purple-50 rounded-lg p-3">
          ...
          <div className="text-lg font-bold text-purple-900">{incident.crowdData.density}%</div>
          <div className="text-xs text-purple-700">
            {incident.crowdData.evacuated} evacuated
          </div>
        </div>
      )}
