// Firebase Firestore Setup Script for Local Execution (CommonJS)
// Run this with: node firebase-setup-local.cjs

const admin = require('firebase-admin');

// Initialize Firebase Admin with your project ID
// You can use Application Default Credentials or a service account key
admin.initializeApp({
