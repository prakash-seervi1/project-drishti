...
class ResponseDispatcherAgent(BaseAgent):
    def __init__(self):
        ...
        short_term = ShortTermMemory(prefix="dispatcher")
        super().__init__("dispatcher", memory, tools, comms, short_term)
    ...
    def handle_event(self, event, session_id="default"):
        ...
        prompt = (
            f"Recent dispatch events (short-term):\n{short_term_context}\n"
        ...
        self.append_short_term(session_id, f"Dispatch: {dispatch}")
        return dispatch
